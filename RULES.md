...
### নতুন নিয়ম (সংযোজন: ২৭/৪/২০২৬, ১২:৩৭:৪১ PM)
- Credit Sale- পজ থেকে কোন পন্য সম্পূর্ণ ক্রেডিট সেল দিলে সেই এমাউন্ট পার্টি লেজারে Dr(Gave) এ শো করবে ও লেজার ব্যালেন্স এ দেখাবে। 
Credit Sale With Part Payment- কোন পন্য ক্রেডিট ও আংশিক পেমেন্ট করলে সেটি পন্যের মোট মূল্য Dr(Gave) এ শো করবে ও আংশিক পেমেন্ট এর এমাউন্ট রিসেভ হিসেবে দেখাবে Cr (Recv) এ শো করবে ও ব্যালেন্স এ প্রভাব পরবে। 
Cash Sale- সম্পূর্ন ক্যাশে বিক্রি করলে সম্পূর্ন এমাউন্ট Cr(Recv) এর ঘরে শো করবে ও এটি লেজারে প্রভাব পরবে না। 
Income-ইনকামের এমাউন্ট Cr(Recev) এর ঘরে শো করলেও এটি ব্যালেন্স এ প্রভাব পরবে না। 
Expanse - Expanse এর ক্ষেত্রে Dr(Gave) এ শো করলেও ব্যালেন্স এ প্রভাব পরবে না।
Give - গিভ এর ক্ষেত্রে Dr(Gave) এ শো করবে ও ব্যালেন্স এ প্রভাব পরবে।
Receive- রিসিভ এর ক্ষেত্রে Cr(Recv) এ শো করবে ও ব্যালেন্স এ প্রভাব পরবে।
